<template>
    <markdown>
        ...
        In the configuration interface, you will also see a `schema` namespace. This namespace defines types used for type definitions themselves—for example, `schema.valuetype` can be used to select a type.

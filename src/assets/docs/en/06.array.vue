<template>
    ...
    <markdown>
        ...
        If the struct elements within the array contain nested struct arrays, the child arrays will be expanded and displayed inline—but only up to **two levels of nesting** are supported.
    </markdown>

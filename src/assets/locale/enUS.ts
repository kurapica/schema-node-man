...
importLanguage("enUS", {
  ...
  "system.str.match": "Contains specified string",
  ...
  "system.math.maxs": "Max of Multiple Numbers",
  "system.math.min": "Minimum",
  "system.math.mins": "Min of Multiple Numbers",
  ...
  "system.math.add": "+",
  "system.math.adds": "Add Multiple Numbers",
  "system.math.addnull": "+?",
  "system.math.addnulls": "Add Multiple Numbers (Nullable)",
  "system.math.subtract": "-",
  "system.math.subtracts": "Subtract Multiple Numbers",
  "system.math.subtractnull": "-?",
  "system.math.subtractnulls": "Subtract Multiple Numbers (Nullable)",
  "system.math.modulo": "%",
  "system.math.multiply": "*",
  "system.math.multiplys": "Multiply Multiple Numbers",
  "system.math.multiplynull": "*?",
  "system.math.multiplynulls": "Multiply Multiple Numbers (Nullable)",
  "system.math.divide": "/",
  "system.math.bitand": "&",
  "system.math.bitor": "|",
  "system.math.bitxor": "^",
  ...
  "system.collection.orderby": "Array Sort",
  "system.collection.take": "Take First N Elements of Array",
  "system.collection.skip": "Skip First N Elements of Array",
  ...
  "system.data.getappfdatabyonekey":
    "Gets App Data Specified Field by Single Key",
  "system.data.getappfdatabytwokey":
    "Gets App Data Specified Field by Two Keys",
  "system.data.getappfdatabythreekey":
    "Gets App Data Specified Field by Three Keys",
  "system.data.getappfdatabyfourkey":
    "Gets App Data Specified Field by Four Keys",
  ...
  "system.workflow.event.appdatapayload":
    "Application Target Data Access Event Payload",
  ...
  "system.workflow.event.appfielddatapayload":
    "Application Field Data Change Event Payload",
  ...
  "system.schema.structfieldflags.useoriginforuplimit":
    "Use Original for Upper Limit",
  ...
  "system.schema.policyscope.datacreate": "Create App Data",
  "system.schema.policyscope.dataread": "Read App Data",
  ...
  "system.schema.appscopetype": "App Scope Type",
  "system.schema.appscopetype.businesstarget": "Business Target",
  "system.schema.appscopetype.systemlevel": "System Level",
  "system.schema.appscopetype.isolationcontext": "Isolation Context",
  ...
  "system.schema.structfieldconfig.useOriginForUpLimit":
    "Use Original for Upper Limit",
  ...
  "system.schema.appfieldschema.template": "Enable template download and upload data",
  "system.schema.appfieldschema.tableName": "Specify storage table name",
  "system.schema.appfieldschema.attrTableName": "Specify EAV storage table name",
  ...
  "system.schema.appworkflownodeschema.cancelPre":
    "Cancel Previous Fork Branches",
  ...
  "system.schema.appgetsourceappblacklist":
    "Get App Field Reference App Blacklist",
  "system.schema.appgetsourceappfldinfo":
    "Get App Field Reference App Field Info",
  ...
  "system.schema.appscopecontextmap": "App Scope Context Map",
  "system.schema.appscopecontextmap.contextItem": "Context Item",
  "system.schema.appscopecontextmap.mapKey": "Map Key",

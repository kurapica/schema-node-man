<template>
    <el-table :data="rows" :border="true" header-align="left" :header-cell-style="{ background: '#eee' }">
        <el-table-column align="left" prop="label" :label="_L['schema.app.fieldvalarg']" min-width="120" />
        <el-table-column align="left" :label="_L['schema.app.srcfld']" min-width="120">
